                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-12 col-12">
                            <img src="images/news/news-detail-header.webp" className="img-fluid news-detail-image" alt="fine dining experience" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-7 col-12 mx-auto">
                            <form className="custom-form comment-form" action="#" method="get" role="form">
                                ...
                                <input type="email" name="comment-email" id="comment-email" pattern="[^ @]*@[^ @]*" className="form-control" placeholder="Your Email" required={false} />
                            
                                <textarea className="form-control" rows={0} id="comment" name="comment" placeholder="Write a comment" required></textarea>
                            ...
                            <div className="news-author d-flex flex-wrap align-items-center">
                                <img src="images/author/alexander-hipp-iEEBWgY_6lA-unsplash.webp" className="img-fluid news-author-image" alt="" />
                            ...
                            <div className="news-author d-flex flex-wrap align-items-center">
                                <img src="images/author/shoeib-abolhassani-ojl7T2Ah93U-unsplash.webp" className="img-fluid news-author-image" alt="" />
                            ...
                            <div className="news-thumb mb-4">
                                ...
                                <div className="news-text-info">
                                    ...
                                    <h5 className="news-title mt-2">
                                        <a href="/news-detail" className="news-title-link">Is Coconut good for your health?</a>
                                    </h5>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                ...
                                <div className="news-text-info">
                                    ...
                                    <h5 className="news-title mt-2">
                                        <a href="/news-detail" className="news-title-link">How to run a sushi business?</a>
                                    </h5>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                ...
                                <div className="news-text-info">
                                    ...
                                    <h5 className="news-title mt-2">
                                        <a href="/news-detail" className="news-title-link">Learning a fine dining experience</a>
                                    </h5>
                                </div>
                            </div> 
                        </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-12">
                            <img src="images/charles-deluvio-FdDkfYFHqe4-unsplash.webp" className="img-fluid newsletter-image" alt="" />
                        </div>
                        ...
                        <div className="col-lg-6 col-12 d-flex align-items-center mt-5 mt-lg-0 mx-auto">
                            <div className="subscribe-form-wrap">
                                ...
                                <form className="custom-form subscribe-form mt-4" role="form">
                                    <input type="email" name="subscribe-email" id="subscribe-email" pattern="[^ @]*@[^ @]*" className="form-control" placeholder="Your email address" required={false} />
